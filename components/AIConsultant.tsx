...
const chatMessages = [
  {
    id: 1,
    type: 'user',
    message: 'Ищу подарок для жены на годовщину. Бюджет до 7 000 000 сум.',
    timestamp: '14:32'
  },
  {
    id: 2,
  ...
  },
  {
    id: 4,
    type: 'ai',
    message: 'Отличный выбор! У нас есть коллекция колец с сапфирами от 4 900 000 сум и изумрудами от 5 880 000 сум. Также рекомендую обратить внимание на кольцо с танзанитом — очень редкий камень, 6 720 000 сум. Какой камень она предпочитает?',
    timestamp: '14:33'
  },
  {
    id: 5,
  ...
  },
  {
    id: 6,
    type: 'ai',
    message: 'Идеально! У нас есть кольцо с синим сапфиром 2 карата в платиновой оправе за 6 300 000 сум. Могу организовать примерку или доставку курьером с возможностью возврата. Хотите посмотреть фото?',
    timestamp: '14:34'
  }
]
