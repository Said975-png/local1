...
const chatMessages = [
  {
    id: 1,
    type: 'user',
    message: 'Ищу подарок для же��ы на годовщину. Бюджет до 7 000 000 сум.',
    timestamp: '14:32'
  },
  {
    id: 2,
  ...
  },
  {
    id: 6,
    type: 'ai',
    message: 'Идеально! У нас есть кольцо с синим сапф��ром 2 карата в платиновой оправе за 45 000₽. Могу организовать примерку или доставку курьером с возможностью возврата. Хотите посмотреть фото?',
    timestamp: '14:34'
  }
]
