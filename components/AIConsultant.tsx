...
const chatMessages = [
  ...
  },
  {
    id: 4,
    type: 'ai',
    message: 'Отличный выбор! У нас есть коллекция колец с са��фирами от 4 900 000 сум и изумрудами от 5 880 000 сум. Также рекомендую обратить внимание на кольцо с танзанитом — очень редкий камень, 6 720 000 сум. Какой камень она предпочитает?',
    timestamp: '14:33'
  },
  {
    id: 5,
